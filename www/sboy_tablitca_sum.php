...
<div style='background:#eeeeee; width:565px'>
	<table border='1' cellpadding='1' cellspacing='0'>
		<tr valign='center'>
			...
			<td align='center' width='150' colspan="4"><span class='g14'>Не устранено</span></td>
		</tr>
		<tr valign='center'>
...
//0
				...
				$resav = mysql_query ("SELECT * FROM avariya WHERE (nden = $den0 and nmes = $mes0 and ngod = $god0)",$db);
				$rowav = mysql_fetch_array($resav);
				do
				{	if ($rowav['ustroystvo'] == 'Системный блок' or $rowav['ustroystvo'] == 'Монитор' or $rowav['ustroystvo'] == 'ПО')
					{$KN0++;}
					if ($rowav['ustroystvo'] == 'ИБП')
					{$IN0++;}
...
$K1=$K0-$KN0+$KK0; $I1=$I0-$IN0+$IK0; $S1=$S0-$SN0+$SK0; $P1=$P0-$PN0+$PK0;
$K2=$K1-$KN1+$KK1; $I2=$I1-$IN1+$IK1; $S2=$S1-$SN1+$SK1; $P2=$P1-$PN1+$PK1;
$K3=$K2-$KN2+$KK2; $I3=$I2-$IN2+$IK2; $S3=$S2-$SN2+$SK2; $P3=$P2-$PN2+$PK2;
$K4=$K3-$KN3+$KK3; $I4=$I3-$IN3+$IK3; $S4=$S3-$SN3+$SK3; $P4=$P3-$PN3+$PK3;
$K5=$K4-$KN4+$KK4; $I5=$I4-$IN4+$IK4; $S5=$S4-$SN4+$SK4; $P5=$P4-$PN4+$PK4;
$K6=$K5-$KN5+$KK5; $I6=$I5-$IN5+$IK5; $S6=$S5-$SN5+$SK5; $P6=$P5-$PN5+$PK5;
...
printf("
		<tr valign='center' onmouseover='this.className=\"lineSelected\";' onmouseout='this.className=\"lineOne\";'>
			...
			<td align='center'><span class='k12'>$IN6</span></td>
			...
			<td align='center'><span class='k12'>$IK6</span></td>
			<td align='center'><span class='k12'>$SK6</span></td>
			<td align='center'><span class='k12'>$PK6</span></td>
			<td align='center'><span class='k12'>$K6</span></td>
			<td align='center'><span class='k12'>$I6</span></td>
			<td align='center'><span class='k12'>$S6</span></td>
			<td align='center'><span class='k12'>$P6</span></td>
		</tr>
		<tr valign='center' onmouseover='this.className=\"lineSelected\";' onmouseout='this.className=\"lineOne\";'>
			<td align='center'><span class='g12'>$den5.$mes5.$god5</span></td>
			<td align='center'><span class='k12'>$KN5</span></td>
			<td align='center'><span class='k12'>$IN5</span></td>
			...
			<td align='center'><span class='k12'>$IK5</span></td>
			<td align='center'><span class='k12'>$SK5</span></td>
			<td align='center'><span class='k12'>$PK5</span></td>
			<td align='center'><span class='k12'>$K5</span></td>
			<td align='center'><span class='k12'>$I5</span></td>
			<td align='center'><span class='k12'>$S5</span></td>
			<td align='center'><span class='k12'>$P5</span></td>
		</tr>
		<tr valign='center' onmouseover='this.className=\"lineSelected\";' onmouseout='this.className=\"lineOne\";'>
			<td align='center'><span class='g12'>$den4.$mes4.$god4</span></td>
			<td align='center'><span class='k12'>$KN4</span></td>
