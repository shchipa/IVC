...
{//Заносим информацию
	$insert = mysql_query ("UPDATE avariya SET nden='$nden', nmes='$nmes', ngod='$ngod', nchas='$nchas', nmin='$nmin', invnomer='$invnomer', prim='$prim', mehanik='$_SESSION[adminUser]' WHERE id='$id'");
	if ($insert == 'true') 
	{
