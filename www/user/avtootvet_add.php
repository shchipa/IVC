...
<td>
<p class='g18' align="center">Добавление автоответа</p>
<form action="avtootvet_insert.php" method="post" name="avtootvetu" >

<table width="100%" border="0" cellpadding="5" cellspacing="0" align="center">
	<tr class="g14">
		<td width="50%" height="50" align="right">Автоответ:</td>
		<td align="left">
			<input name="avtootvet" readonly type="text" value="<?php printf("(%s)%s",$add_avtootveta, $avtootvet_nom);?>" size="10" maxlength="13" readonly="readonly">
			<input name='avtootvet_ser' type='hidden' value='<? echo $add_avtootveta; ?>'>
			<input name='avtootvet_nom' type='hidden' value='<? echo $avtootvet_nom; ?>'>
		</td>
	</tr>
	<tr class="g14">
