...
if (isset($upd)&&isset($id)&&isset($fio)&&isset($nden)&&isset($nmes)&&isset($ngod)&&isset($nchas)&&isset($nmin)&&isset($prim)&&isset($ust)&&isset($slujba)&&isset($rabmesto)&&isset($ustroystvo)&&isset($station))
{//Заносим информацию
	if ($ust == 0)
	{$kden=''; $kmes=''; $kgod=''; $kchas=''; $kmin='';}
	$insert = mysql_query ("UPDATE avariya SET station='$station', slujba='$slujba', rabmesto='$rabmesto', ustroystvo='$ustroystvo', nden='$nden', nmes='$nmes', ngod='$ngod', nchas='$nchas', nmin='$nmin', kden='$kden', kmes='$kmes', kgod='$kgod', kchas='$kchas', kmin='$kmin', prim='$prim', ust='$ust' WHERE id='$id'");
	if ($insert == 'true') 
	{
